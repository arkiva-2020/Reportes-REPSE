...
include("../conexion/conexion.php");
    ...
    if ($data) {            
            ...
            CROSS APPLY(SELECT * FROM dbo.fnSplit(t.Proveedor_Id,',') where t.ObjID in ($naranja)) Proveedor_Id   
            )t1 
            ...
            where contrato.Empresa_Interna_ID in ($naranja) 
