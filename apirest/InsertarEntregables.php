...
if(isset($_FILES["pdf"])){
	...
	$compra		= 	"Entregables Recibidos";
    $result     =   $compra.'_'.$random.'.'.$extension;
    

    move_uploaded_file($temp, '../documentos/entregables-recibidos/'.$result); 
            
	$sql="EXECUTE InsertarOrdenDeCompra N'Entregables Recibidos: $random', N'$id' ";    
